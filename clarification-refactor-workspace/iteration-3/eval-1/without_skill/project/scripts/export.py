...
def export_data(output_file, dry_run=False):
    ...
    Args:
        ...
        dry_run: If True, show what would be exported without writing files
    """
    ...
    if dry_run:
        ...
        print(f"[DRY RUN] Would create directory: {output_path.parent}")
        print(f"[DRY RUN] Preview of data:")
