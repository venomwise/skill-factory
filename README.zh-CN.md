...
> 这个仓库同时包含面向使用者的技能，以及面向技能编写的辅助能力。
...
| [skill-creator](./skill-creator/) | 用于创建和迭代优化技能。 |
| [skill-factory](./skill-factory/) | 带有检查点和工具链的系统化技能创建/优化流程。 |
| [spec-exec](./spec-exec/) | 根据已批准设计中的 Acceptance Criteria 执行 `tasks.md` 并跟踪进度。 |
| [spec-plan](./spec-plan/) | 从已批准的 `design.md` 生成可追溯的 `tasks.md`。 |
...
手动运行对应的脚本或工作流，并尽量使用确定性、可重复的验证方式。
